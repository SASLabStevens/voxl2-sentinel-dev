...
def data_stream(udp_url='udp:0.0.0.0:14551', file_name='info.csv', tilt_angle_from_x = 0):
    ...
    dg = DataGenerator("data", "GOPROMINI11", "StevensLibrary")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='GPS Data Stream Visualization')
    # Add an argument for tilt_angle_from_x
    parser.add_argument('--tilt_angle', type=float, required=True, help='Tilt angle from the x-axis in degrees')
    args = parser.parse_args()
    tilt_angle_from_x = args.tilt_angle
    data_stream(tilt_angle_from_x=tilt_angle_from_x)